...
//                             @2026 PharmInc. All rights reserved
//                         </p>
//                     </div>
//                 </div>
//             </motion.div>
    ...
    return (
        <footer className="w-full">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                variants={containerVariants}
                className="px-4 sm:px-8 pt-6 bg-black  border-t border-gray-800 "
            >
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col items-center justify-center text-center mb-10 sm:mb-14">
                        <motion.div variants={itemVariants}>
                            <h2
                                className="text-white font-['Poppins'] font-bold text-[1.8rem] sm:text-[2.2rem] leading-[100%] mb-4"
                            >
                                Contact Us
                            </h2>
                    ...
                    {/* CONTACT INFO ROW */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-6 md:gap-8 mb-8">
                        ...
                        >
                            <h3
                                className="text-white mb-4 font-['Poppins'] font-semibold text-[1rem] leading-[100%]"
                            >
                                Address
                            </h3>

                            <p
                                className="text-gray-300 font-['Poppins'] font-normal text-[0.95rem] leading-[170%] max-w-[18rem]"
                            >
                                123 Street Wellness City,
                        ...
                        >
                            ...
                            <a
                                href="mailto:support@gmail.com"
                                className="text-gray-300 hover:text-[#06b6d4] transition font-['Poppins'] font-normal text-[0.95rem] leading-[170%]"
                            >
                                support@gmail.com
                            </a>
                        </motion.div>
                    ...
                    <div
                        className="flex flex-col sm:flex-row sm:justify-end justify-center items-center h-full text-white bg-black "
                    >
                        <p className="font-['Poppins'] font-normal text-[15px] leading-[100%] mb-4 text-center w-full">
                            @2026 PharmInc. All rights reserved
                        </p>
                    </div>
                </div>
