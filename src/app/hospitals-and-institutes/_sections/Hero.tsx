...
export default function Hero() {
    ...
    return (
        <div className="relative w-full  overflow-hidden pb-46 md:pb-85 lg:pb-115  xl:pb-100">
            <div
            ...
            >
                ...
                <div className="absolute  z-1 top-[-130px] left-1/2 -translate-x-1/2 h-[240px] w-[240px] xl:w-[380px] xl:h-[340px] pointer-events-none opacity-100 blur-[80px]"
                    style={{
            ...
            <div
                className="absolute hidden lg:block z-10 w-[15.38rem] h-[11.44rem] top-115 lg:top-100 lg:right-0 right-5 opacity-100 rotate-15"
            >
                <Image
            ...
            {/* <div className="z-30  inset-x-0 relative bottom-20  xl:bottom-45 flex justify-center pointer-events-none">
                <Image
